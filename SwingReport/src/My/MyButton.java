...
//        setUI(new WindowsButtonUI());
	...
	public class MyButtonUI extends WindowsButtonUI{
	    ...
	    protected void paintText(Graphics g, AbstractButton b, Rectangle textRect, String text) {
	        ...
	        int[] ypoints = new int[]{y1+(y1-4)/2,y1+(y1-4)/2+4,y1+(y1-4)/2};
	        ...
	        if(hovered){
		        ...
		        g2d.fill3DRect(extSensor.x, extSensor.y, extSensor.width, extSensor.height, true);
	        }	
	    ...
	    public Dimension getPreferredSize(JComponent c) {
	        ...
	        Dimension old = BasicGraphicsUtils.getPreferredButtonSize(b, b.getIconTextGap());
